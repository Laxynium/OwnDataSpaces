    ...
    where T : DockerContainer
{
    ...
    private readonly string _existingContainerConnectionString;
    ...
    public TryToUseExistingContainer(string envVariableName,
        string existingContainerConnectionString,
        Func<T> containerFactory,
        Func<T, string> containerConnectionString)
    {
        _envVariableName = envVariableName;
        _existingContainerConnectionString = existingContainerConnectionString;
    ...
    public string GetConnectionString()
    {
        ...
        {
            return _existingContainerConnectionString;
        }
